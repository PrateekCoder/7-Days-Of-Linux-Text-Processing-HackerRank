...
#By default, it displays the first 1010 lines when used in the following form:
...
#Task
#Display the first 2020 lines of an input file.

#Input Format:
#A text file.

#Output Format:
#Output the first 2020 lines of the given text file.
